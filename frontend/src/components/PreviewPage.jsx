...
export default function App() {
  return (
    <div className="text-black p-4 flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <h1 className="text-3xl font-bold mb-8 text-blue-600">Company Yearly Budget</h1>
      ...
      <p className="mt-4 text-gray-600 text-center max-w-2xl">
        ...
        The trend shows an overall increase in budget over the years, with a significant drop in 2019.
      </p>
    </div>
  );
}